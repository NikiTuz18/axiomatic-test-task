...
public class PassportCustomerSearchResolver implements CustomerSearchResolver {

    private final CustomerRepository customerRepository;

    @Override
    public List<DtoCustomer> resolve(CustomerSearch customerSearch) {
        return customerRepository.findByPassport(customerSearch.getSearchQuery()).stream()
